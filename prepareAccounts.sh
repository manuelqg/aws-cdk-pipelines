...
cdk bootstrap 581994098444/us-west-1 --no-bootstrap-customer-key --cloudformation-execution-policies 'arn:aws:iam::aws:policy/AdministratorAccess' --trust 900126642232 --trust-for-lookup 900126642232 --profile prod
